...
class Register(Resource):
    def get(self):
        ...
        plt.title('Weight Variance', fontsize=30, fontproperties=BMJUA)
...
class Register(Resource):
    def get(self):
        ...
        BMJUA = fm.FontProperties(
            fname='/home/ubuntu/anaconda3/envs/python3/fonts/BMJUA_ttf.ttf')
        plt.title('Calories Variance', fontsize=30, fontproperties=BMJUA)
        plt.xticks(rotation=30)
...
class Register(Resource):
    def get(self):
        ...
        BMJUA = fm.FontProperties(
            fname='/home/ubuntu/anaconda3/envs/python3/fonts/BMJUA_ttf.ttf')
        plt.title('Nutrient Variance', fontsize=30, fontproperties=BMJUA)
